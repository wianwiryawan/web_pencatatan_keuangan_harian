...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-700">Tambah Data User</h1>
    </div>
                    ...
                    <div class="col mr-2">
                        ...
                        <form action="<?= base_url('user/simpanData'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= ($validation->hasError('nama_user')) ? 'is-invalid' : ''; ?>" id="inputNamaUser" placeholder="Nama User Baru" name="nama_user" value="<?= old('nama_user'); ?>" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= ($validation->hasError('no_telp')) ? 'is-invalid' : ''; ?>" id="inputNoTelp" placeholder="Nomor Telepon" name="no_telp" value="<?= old('no_telp'); ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>" id="inputUsername" placeholder="Username" name="username" value="<?= old('username'); ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" class="form-control <?= ($validation->hasError('password')) ? 'is-invalid' : ''; ?>" id="inputPassword" placeholder="Password" name="password" value="<?= old('password'); ?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-2 mb-2">
                                    <img src="/img/user/default_profile.png" class="img-thumbnail img-preview">
                                </div>
                                <div class="col-sm-8">
